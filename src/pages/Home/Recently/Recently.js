    ...
    return (
        <div className='mt-20 text-center'>
            <div className="text-start md:flex justify-between">
                <h1 className='text-2xl md:text-5xl text-start pl-5 font-bold ctext2'>Recently order food by you</h1>
                <div  onClick={() => { setViewType('popular') }} className="text-xl pl-5 mt-5 md:pl-0 md:mt-0 md:text-2xl cursor-pointer font-bold swap-on text-red-600">Most Popular</div>
            </div>
            {/* small device */}
                                ...
                                <div className="card cuscard bg-base-100 relative mx-auto rounded-lg w-[300px] cushover1  shadow-xl mt-10 overflow-hidden">
                                    ...
                                    <div className="absolute cuscard-body rounded-lg p-5 -right-full text-start text-white w-full h-full cusCardBody">
                                        ...
                                        <div className=" justify-start absolute pl-3 bottom-0">
                                            <button className="btn btn-ghost text-red-600 cbtn1  mx-auto w-[230px]">Order Again</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
